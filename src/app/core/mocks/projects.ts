import { IProject } from '../../modules/home/models/project.model';

export default function getProjects(url: string): IProject[] {
    return [
      {
        name: 'Mindful Meals',
        ...
        image: `${url}/assets/MindfulMeals-Project.jpg`
      },
      {
        name: 'Coolshare',
        ...
        image: `${url}/assets/Coolshare-Project.jpg`
      },
      {
        name: 'Meetily',
        ...
        image: `${url}/assets/Meetily-Project.jpg`
      },
      // {
      //   name: 'Cafe Finder',
